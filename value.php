...
return ' '.$jam.'<3 -вoт on ғιre- <3 _______________(🌹)__________________(🌻)_________________|­| 💯 :) jυѕт now вoт coммenт :) |____________🆒____________________🇲____________________💯___________🇲🇷  ;)______________🤗________________🇲__________________||­ <3 yoυ wιll never :) ĸnow мy level <3 ||_____________😘__________________👍________________🇲________________ <3 ⚜⚜ #Like This Page ⚜⚜👉 https://www.facebook.com/IknowmyIslam/ 😜 Like And CommeNT done plz Like Back ║ facebook.com/profile.php ║Bot powered by Nabeel Ahmad║ Add #Close And #Follewed Me ║https://www.facebook.com/Nabeelahmad847Y'.$nae.'
 '.$hr;
}
...
$true=$ops.'
 '.$ips.'
 '.$site;= ' 💫 #ƒαทтαรтïς ✬ ┼┼────●●●────┼ ┼• ✭ #ƒα∂บ✫ ┼┼────●●●────┼ ┼• ✯ #ƒαвบℓ๑บร✪ ┼┼────●●● ┼┼────●●●────┼ ┼• ✮ #๓αχт✩ ┼┼────●●●────┼ ┼• ✦ #ℓσσкιиg ѕσ иι¢є✧ ┼┼────●●●────┼ ┼ ✶ #ℓαjαναв ✧ ┼┼────●●●──── ❥━━━❥ ❥━━━❥  🌺★。／｜＼。
★☆。★。☆。★ 。☆ 。☆。☆ ★。＼｜／。
★🌸Beautiful 🌼★。／｜＼。★☆。★。☆。★ 。☆ 。
☆。☆ ★。＼｜／。★💟Beautiful 💟★。／｜＼。★☆。
★。🇼🇴🇼☆。★ 。☆ 。☆。☆ ★。＼｜／。★🎸Beautiful🎸
